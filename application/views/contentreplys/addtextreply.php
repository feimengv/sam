				...
				<div class="row-fluid">
					<div class="span12">
                        <div class="widget-box">
							...
							<?=validation_errors()?>
								<form action="<?php echo site_url('contentreplys/addtextreply')?>" method="post"   class="form-horizontal">
								    ...
								    <div class="control-group">
										...
										<div class="controls">
											<input name="data[keywords]" type="text" size="91" maxlength="60" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="data[content]" id="textarea" cols="80" rows="7"></textarea>
										</div>
									</div>
