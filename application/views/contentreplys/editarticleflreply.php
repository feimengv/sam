					...
					<div class="span12">
                        <div class="widget-box">
							<div class="widget-title">
								...
								<h5>文章分类回复修改<font color="red">(*代表必填写)</font></h5>
							</div>
							...
							<?echo validation_errors()?>
								<form action="<?=site_url('contentreplys/editarticleflreply/'.$cateid)?>" method="post" class="form-horizontal">
								    ...
								    <div class="control-group">
										...
										<div class="controls">
											<input id="catename" name="data[catename]" value="<?=$catename?>" type="text" size="91" maxlength="30">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id="addressweb" name="data[addressweb]" value="<?=$addressweb?>" type="text" size="91" maxlength="300">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">排序</label>
										<div class="controls">
											<input id="orders" name="data[orders]" value="<?=$orders?>" type="text" size="91" maxlength="200">
										</div>
									</div>
