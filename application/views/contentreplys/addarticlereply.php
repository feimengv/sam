					...
					<div class="span12">
                        <div class="widget-box">
							...
							<?echo validation_errors()?>
								<form action="<?=site_url('contentreplys/addarticlereply')?>" method="post"   class="form-horizontal">
								...
								<input type="hidden" name="data[addtime]" value="<?=time()?>">
								    <div class="control-group">
										...
										<div class="controls">
											<input id="keyword" name="data[keyword]" type="text" size="91" maxlength="30">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="radio" name="data[keymatch]" value=0 checked>
											<span class="radiocon">完全匹配</span>
											<input type="radio" name="data[keymatch]" value=1>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input id="title" name="data[title]" type="text" size="91" maxlength="60" >
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">简介<font class="keyred">*</font></label>
										<div class="controls">
											<textarea name="data[introduction]" id="textarea" cols="80" rows="5"></textarea>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input name="data[orders]" type="text" size="30" maxlength="60" >
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
										  <input type="radio" name="data[accesstype]" value=0 checked onClick="article1()">
										  <span class="radiocon">站内文章</span>
										  <input type="radio" name="data[accesstype]" value=1 onClick="article2()">
									...
									<div class="control-group hidden" id="articleaddress">
										...
										<div class="controls">
											<input name="data[articleaddress]"  type="text" size="91" maxlength="200" >
									...
									<div class="control-group" id="contentcss">
										...
										<div class="controls">
										<textarea id="editor_id" name="data[content]" style="width:600px;height:400px;visibility:hidden;"></textarea>
										<script>
