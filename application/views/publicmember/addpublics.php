					...
					<div class="span12">
                        <div class="widget-box">
							...
							<?php echo validation_errors(); ?>
								<form id="form1" action="<?=site_url('publicmember/addpublics')?>" method="post"   class="form-horizontal">
								...
								<input type="hidden" name="data[author]" value="<?=$this->userdata['username']?>">
                                    <div class="control-group">
										...
										<div class="controls">
											<input name="data[Public]" id="Public" type="text" size="91" maxlength="30" >
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">微信号<font class="keyred">*</font></label>
										<div class="controls">
											<input name="data[Weixinhao]" id="Weixinhao" type="text" size="91" maxlength="200" >
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">微信号原始ID<font class="keyred">*</font></label>
										<div class="controls">
											<input name="data[Oldweixinhao]" id="Oldweixinhao" type="text" size="61" maxlength="200" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<input name="data[Imgaddress]" id="Imgaddress" type="text" size="91" maxlength="200" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="data[description]" id="description" id="textarea" cols="80" rows="5"></textarea>
										</div>
									</div>
